export const NetworkSLAWithStreamRecreationABI = [
  {
  ...
  // Add the updated ViolationDetected event
  {
    anonymous: false,
    inputs: [
      { indexed: true, name: "slaId", type: "uint256" },
  ...
  // Add the updated ComplianceChecked event
  {
    anonymous: false,
    inputs: [
      { indexed: true, name: "slaId", type: "uint256" },
      { indexed: false, name: "fromMetricId", type: "uint256" },
      { indexed: false, name: "toMetricId", type: "uint256" },
      { indexed: false, name: "violationsFound", type: "uint256" },
    ],
    name: "ComplianceChecked",
    type: "event",
  },
